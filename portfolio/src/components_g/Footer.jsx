...
const Footer = () => {
  return (
    <footer className="bg-sand dark:bg-gray-900 text-charcoal dark:text-silver py-12 relative overflow-hidden border-t border-gray-300/60 dark:border-white/[0.06] transition-colors duration-500">
      {/* Animated Background */}
