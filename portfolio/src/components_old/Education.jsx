          ...
          {educationData.map((item, index) => (
            ...
            >
              ...
              <div className="absolute left-8 md:left-1/2 transform -translate-x-1/2 flex items-center justify-center z-10">
                <motion.div
                  className="w-10 h-10 md:w-14 md:h-14 rounded-full bg-gray-50 dark:bg-gray-900 border-2 border-secondary-500 flex items-center justify-center shadow-[0_0_15px_rgba(245,158,11,0.4)]"
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    >
                      ...
                      <span className="px-3 py-1 rounded-lg bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 text-sm font-bold shadow-sm border border-emerald-100 dark:border-emerald-900/30">
                        {item.score}
                      </span>
                    </div>
                  </div>
